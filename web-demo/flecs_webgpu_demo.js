...
function findWasmBinary() {
    return locateFile('flecs_webgpu_demo.wasm');
}
...
var ASM_CONSTS = {
  1232088: () => { console.log('Setting up Emscripten main loop from JavaScript'); },  
 1232156: () => { console.log('Main loop setup complete'); },  
 1232201: () => { console.log('Main function starting (WebAssembly)'); },  
 1232258: () => { console.error('Failed to initialize engine: no world created'); },  
 1232326: () => { console.log('Demo initialized successfully, setting up main loop'); },  
 1232398: () => { console.log('Main function completed, main loop will start asynchronously'); },  
 1232479: () => { console.log('WebGPU: Initializing renderer'); },  
 1232529: () => { console.log('WebGPU: Instance creation attempted'); },  
 1232585: () => { console.log('WebGPU: Failed to create instance'); },  
 1232639: () => { console.log('WebGPU: Instance created successfully'); },  
 1232697: () => { console.log('WebGPU: Requesting adapter asynchronously...'); },  
 1232762: ($0) => { console.log('WebGPU: Adapter callback received, status:', $0); },  
 1232829: () => { console.error('WebGPU: Adapter request failed'); },  
 1232882: () => { console.log('WebGPU: Adapter acquired successfully, now requesting device...'); },  
 1232966: ($0) => { console.log('WebGPU: Device callback received, status:', $0); },  
 1233032: () => { console.error('WebGPU: Device request failed'); },  
 1233084: () => { console.log('WebGPU: Device and queue acquired successfully - WebGPU pipeline ready!'); },  
 1233176: () => { console.log('WebGPU: Depth buffer created successfully'); },  
 1233238: () => { console.error('WebGPU: Failed to create depth buffer'); },  
 1233298: () => { console.log('WebGPU: Surface configured for rendering'); },  
 1233359: ($0, $1) => { console.error('WebGPU Error:', UTF8ToString($0), UTF8ToString($1)); console.error('Stopping render loop due to WebGPU error'); },  
 1233490: () => { console.log('Main loop: First run starting'); },  
 1233540: () => { console.log('Main loop: No world, canceling loop'); },  
 1233596: () => { try { Module.ecs_progress_safe = true; } catch(e) { Module.ecs_progress_safe = false; console.error('Pre-progress error:', e); } },  
 1233729: ($0) => { console.log('Frame:', $0, 'ECS running normally'); },  
 1233784: ($0, $1) => { console.log('ECS progress stopping: continue=', $0, 'success=', $1); },  
 1233857: () => { console.log('Flecs world created successfully'); },  
 1233910: () => { console.log('WebGPU systems imported successfully'); },  
 1233967: () => { console.log('About to create renderer entity'); },  
 1234019: () => { console.log('Renderer entity created, adding EcsCanvas'); },  
 1234081: () => { console.log('EcsCanvas added, adding WebGPURenderer'); },  
 1234140: () => { console.log('WebGPURenderer added, adding WebGPUQuery'); },  
 1234201: () => { console.log('Renderer entity created'); },  
 1234245: () => { console.log('Attempting manual WebGPU initialization'); },  
 1234305: () => { console.log('WebGPU instance created successfully'); },  
 1234362: () => { console.log('WebGPU surface created successfully'); },  
 1234418: () => { console.log('Failed to create WebGPU surface'); },  
 1234470: () => { console.log('Failed to create WebGPU instance'); },  
 1234523: () => { console.log('WebGPU: Requesting adapter from manual init...'); },  
 1234590: () => { console.log('Demo scene created with 5 entities'); },  
 1234645: () => { console.log('Deferred: Setting up main loop'); },  
 1234696: () => { console.error('Deferred: No world available for main loop'); },  
 1234761: () => { console.log('Deferred: Starting main loop with timeout'); setTimeout(function() { try { Module._setup_emscripten_main_loop(); } catch(e) { console.error('Failed to setup main loop:', e); } }, 100); }
};
...
function assignWasmExports(wasmExports) {
  ...
  dynCalls['viji'] = dynCall_viji = createExportWrapper('dynCall_viji', 4);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = flecs_webgpu_demo;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = flecs_webgpu_demo;
} else if (typeof define === 'function' && define['amd'])
  define([], () => flecs_webgpu_demo);
